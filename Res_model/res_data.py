...
def generate_path_label():
    ...
    generate_path_label_order_csv('../data/predict_probe.csv', probe_predict)  # just for count
    generate_path_label_order_csv('../data/predict_gallery.csv', gallery_predict)  # just for count
