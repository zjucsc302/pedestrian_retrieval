...
class Train_Flags():
    def __init__(self):
        ...
        self.checkpoint_name = 'model_trip_improve_evgloss.ckpt'
        ...
        with open(self.dataset_train_1000_gallery_csv_file_path, 'r') as f:
            self.train_1000_gallery_num = sum([1 for row in csv.reader(f)])
        with open(self.dataset_train_1000_probe_csv_file_path, 'r') as f:
            self.train_1000_probe_num = sum([1 for row in csv.reader(f)])
...
class Vgg19:
    ...
    def train_batch_inputs(self, dataset_csv_file_path, batch_size):
        ...
        with tf.name_scope('train_batch_processing'):
            ...
            resized_ref = my_preprocess_train(ref, output_height=IMAGE_HEIGHT, output_width=IMAGE_WIDTH)
            resized_pos = my_preprocess_train(pos, output_height=IMAGE_HEIGHT, output_width=IMAGE_WIDTH)
            resized_neg = my_preprocess_train(neg, output_height=IMAGE_HEIGHT, output_width=IMAGE_WIDTH)
